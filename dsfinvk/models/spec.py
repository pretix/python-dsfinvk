from .fields import StringField, NumericField
...
class Bonpos(Model):
    ...
    Z_KASSE_ID = StringField(_d="ID der (Abschluss-) Kasse")
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    BON_ID = StringField(_d="Vorgangs-ID")
    POS_ZEILE = StringField(_d="Zeilennummer")
    GUTSCHEIN_NR = StringField(_d="Gutschein-Nr.")
    ARTIKELTEXT = StringField(_d="Artikeltext")
    POS_TERMINAL_ID = StringField(_d="ID des Positions-Terminals")
    GV_TYP = StringField(_d="Geschäftsvorfall-Art")
    GV_NAME = StringField(_d="Zusatz zu der Geschäftsvorfall-Art ")
    INHAUS = StringField(_d="Verzehr an Ort und Stelle")
    P_STORNO = StringField(_d="Positionsstorno-Kennzeichnung")
    AGENTUR_ID = NumericField(places=0, _d="ID der Agentur")
    ART_NR = StringField(_d="Artikelnummer")
    GTIN = StringField(_d="GTIN")
    WARENGR_ID = StringField(_d="Warengruppen-ID")
    WARENGR = StringField(_d="Bezeichnung Warengruppe")
    MENGE = NumericField(places=3, _d="Menge")
    FAKTOR = NumericField(places=3, _d="Faktor, z. B. Gebindegrößen")
    EINHEIT = StringField(_d="Maßeinheit, z. B. kg, Liter oder Stück")
...
class Bonpos_Preisfindung(Model):
    ...
    BON_ID = StringField(_d="Vorgangs-ID")
    POS_ZEILE = StringField(_d="Zeilennummer")
    TYP = StringField(_d="Basispreis, Rabatt oder Zuschlag")
    UST_SCHLUESSEL = NumericField(places=0, _d="ID des USt-Satzes")
...
class Bonpos_Zusatzinfo(Model):
    ...
    BON_ID = StringField(_d="Vorgangs-ID")
    POS_ZEILE = StringField(_d="Zeilennummer")
    ZI_ART_NR = StringField(_d="Artikelnummer")
    ZI_GTIN = StringField(_d="GTIN")
    ZI_NAME = StringField(_d="Artikelbezeichnung")
    ZI_WARENGR_ID = StringField(_d="Warengruppen-ID")
    ZI_WARENGR = StringField(_d="Bezeichnung Warengruppe")
    ZI_MENGE = NumericField(places=3, _d="Menge")
    ZI_FAKTOR = NumericField(places=3, _d="Faktor, z. B. Gebindegrößen")
    ZI_EINHEIT = StringField(_d="Maßeinheit, z. B. kg, Liter oder Stück")
...
class Bonkopf(Model):
    ...
    BON_TYP = StringField(_d="Bontyp")
    BON_NAME = StringField(_d="Zusatz-Beschreibung zum Bontyp")
    TERMINAL_ID = StringField(_d="ID des Erfassungsterminals")
    BON_STORNO = StringField(_d="Storno-Kennzeichen")
    BON_START = StringField(_d="Zeitpunkt des Vorgangsstarts")
    BON_ENDE = StringField(_d="Zeitpunkt der Vorgangsbeendigung")
    BEDIENER_ID = StringField(_d="Bediener-ID")
    BEDIENER_NAME = StringField(_d="Bediener-Name")
    UMS_BRUTTO = NumericField(places=2, _d="Brutto-Gesamtumsatz")
    KUNDE_NAME = StringField(_d="Name des Leistungsempfängers")
    KUNDE_ID = StringField(_d="Kundennummer des Leistungsempfängers")
    KUNDE_TYP = StringField(_d="Art des Leistungsempfängers (z. B. Mitarbeiter)")
    KUNDE_STRASSE = StringField(_d="Straße und Hausnummer des Leistungsempfängers")
    KUNDE_PLZ = StringField(_d="PLZ des Leistungsempfängers")
    KUNDE_ORT = StringField(_d="Ort des Leistungsempfängers")
    KUNDE_LAND = StringField(_d="Land des Leistungsempfängers")
    KUNDE_USTID = StringField(_d="UStID des Leistungsempfängers")
    BON_NOTIZ = StringField(_d="Zusätzliche Informationen zum Bonkopf")
...
class Bonkopf_AbrKreis(Model):
    ...
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    BON_ID = StringField(_d="Vorgangs-ID")
    ABRECHNUNGSKREIS = StringField(_d="z. B. Tischnummer")
...
class Bonkopf_Zahlarten(Model):
    ...
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    BON_ID = StringField(_d="Vorgangs-ID")
    ZAHLART_TYP = StringField(_d="Typ der Zahlart")
    ZAHLART_NAME = StringField(_d="Name der Zahlart")
    ZAHLWAEH_CODE = StringField(_d="Währungscode")
...
class Bon_Referenzen(Model):
    ...
    REF_TYP = StringField(_d="Art der Referenz")
    REF_NAME = StringField(_d="Beschreibung bei Art “ExterneSonstige”")
    REF_DATUM = StringField(_d="Datum des Kassenabschlusses")
    REF_Z_KASSE_ID = StringField(_d="ID der (Abschluss-) Kasse")
    REF_Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    REF_BON_ID = StringField(_d="Vorgangs-ID")
...
class TSE_Transaktionen(Model):
    ...
    TSE_TA_VORGANGSART = StringField(_d="processType der FinishTransaction-Operation")
    TSE_TA_SIGZ = NumericField(places=0, _d="Signaturzähler der FinishTransaction-Operation")
    TSE_TA_SIG = StringField(_d="Signatur der FinishTransaction-Operation")
    TSE_TA_FEHLER = StringField(_d="Ggf. Hinweise auf Fehler der TSE")
...
class Stamm_Abschluss(Model):
    ...
    TAXONOMIE_VERSION = StringField(_d="Version der DFKA-Taxonomie-Kasse")
    Z_START_ID = StringField(_d="Erste BON_ID im Abschluss")
    Z_ENDE_ID = StringField(_d="Letzte BON_ID im Abschluss")
    NAME = StringField(_d="Name des Unternehmens")
    STRASSE = StringField(_d="Straße")
    PLZ = StringField(_d="Postleitzahl")
    ORT = StringField(_d="Ort")
    LAND = StringField(_d="Land")
    STNR = StringField(_d="Steuernummer des Unternehmens")
    USTID = StringField(_d="USTID")
...
class Stamm_Orte(Model):
    ...
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    LOC_NAME = StringField(_d="Name des Standortes")
    LOC_STRASSE = StringField(_d="Straße")
    LOC_PLZ = StringField(_d="Postleitzahl")
    LOC_ORT = StringField(_d="Ort")
    LOC_LAND = StringField(_d="Land")
    LOC_USTID = StringField(_d="USTID")
...
class Stamm_Kassen(Model):
    ...
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    KASSE_BRAND = StringField(_d="Marke der Kasse")
    KASSE_MODELL = StringField(_d="Modellbezeichnung")
    KASSE_SERIENNR = StringField(_d="Seriennummer der Kasse")
    KASSE_SW_BRAND = StringField(_d="Markenbezeichnung der Software")
    KASSE_SW_VERSION = StringField(_d="Version der Software")
    KASSE_BASISWAEH_CODE = StringField(_d="Basiswährung der Kasse")
    KEINE_UST_ZUORDNUNG = StringField(_d="UmsatzsteuerNichtErmittelbar")
...
class Stamm_Terminals(Model):
    ...
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    TERMINAL_ID = StringField(_d="ID des Terminals")
    TERMINAL_BRAND = StringField(_d="Marke der Terminals")
    TERMINAL_MODELL = StringField(_d="Modellbezeichnung des Terminals")
    TERMINAL_SERIENNR = StringField(_d="Seriennummer des Terminals")
    TERMINAL_SW_BRAND = StringField(_d="Markenbezeichnung der Software")
    TERMINAL_SW_VERSION = StringField(_d="Version der Software")
...
class Stamm_Agenturen(Model):
    ...
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    AGENTUR_ID = NumericField(places=0, _d="ID der Agentur")
    AGENTUR_NAME = StringField(_d="Name des Auftraggebers")
    AGENTUR_STRASSE = StringField(_d="Straße")
    AGENTUR_PLZ = StringField(_d="Postleitzahl")
    AGENTUR_ORT = StringField(_d="Ort")
    AGENTUR_LAND = StringField(_d="Land")
    AGENTUR_STNR = StringField(_d="Steuernummer des Auftraggebers")
    AGENTUR_USTID = StringField(_d="USTID des Auftraggebers")
...
class Stamm_USt(Model):
    ...
    UST_BESCHR = StringField(_d="Beschreibung")
...
class Stamm_TSE(Model):
    ...
    TSE_SIG_ALGO = StringField(_d="Der von der TSE verwendete Signaturalgorithmus")
    ...
    TSE_PD_ENCODING = StringField(_d="Text-Encoding der ProcessData (UTF-8 oder ASCII)")
    ...
    TSE_ZERTIFIKAT_II = StringField(_d="Ggf. Rest des Zertifikats (in base64-Codierung)")
...
class Z_GV_Typ(Model):
    ...
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    GV_TYP = StringField(_d="Typ der Geschäftsvorfall-Art")
    GV_NAME = StringField(_d="Name der Geschäftsvorfall-Art")
    AGENTUR_ID = NumericField(places=0, _d="ID der Agentur")
    UST_SCHLUESSEL = NumericField(places=0, _d="ID des Umsatzsteuersatzes")
...
class Z_Waehrungen(Model):
    ...
    Z_ERSTELLUNG = StringField(_d="Zeitpunkt des Kassenabschlusses")
    Z_NR = NumericField(places=0, _d="Nr. des Kassenabschlusses")
    ZAHLART_WAEH = StringField(_d="Währung")
